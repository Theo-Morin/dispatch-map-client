<?php
$nomap = isset($_GET['map']) && $_GET['map'] == "false" ? true : false;
/*
...
<body <?php if($nomap){ echo "onload='$(\"svg\").html(\"\")'"; } ?>>
<div class="container">
    <div id="patrols" ondrop="drop(event)" ondragover="allowDrop(event)">
        <div class="contain">
            <div id="alpha1" ondragstart="drag(event)" class="patrol" draggable="true">Alpha 1</div>
    ...
    <div id="addnote">Ajouter une note sur la carte</div>
    <map name="image-map">
    ...
    <img class="map" draggable="false" usemap="#image-map" src="https://bl3301files.storage.live.com/y4meWdH-aHOCimN_PbGmtOclCXM9mjjsMl0n4DnOqY8Vg28IY4GW0hiPmiVq-T8mnbx9wZrABHCti5hFR1YN3cWoYe1BxHFr5IZEl8xHULPyaqwmP1N9D4tle7PltBXe1vhsz77XPydmiajWDrFwgBb-xqMM1kXJUup5r9gL8HT51FVVMSDW7VxAgCS1bThzu-JdGLx9v5R4YZEvp-2VHJflA/LaserEtch.jpg?psid=1&width=680&height=847" alt="GTA Map" />        
    ...
    <div id="est" class="empty" ondrop="drop(event)" ondragover="allowDrop(event)" style="padding:15px;height:240px;width:220px;position:absolute; top:0; left:50%; transform:translate(-50%,0%); margin-top:260px;margin-left:113px;">
    ...
    <div id="ouest" class="empty" ondrop="drop(event)" ondragover="allowDrop(event)" style="z-index:2;padding:15px;height:150px;width:250px;position:absolute; top:270px; left:50%; tranform:translate(-50%,0%); margin-left:-240px;">
    ...
    <!--<div id="sud-est" class="empty" ondrop="drop(event)" ondragover="allowDrop(event)" style="padding:15px;height:200px;width:351px;position:absolute; top:0; left:50%; transform:translate(-50%,0%); margin-top:105px;margin-left:44px;">
        <svg height="210" width="351">
            <polygon points="0,165,27,138,45,122,51,112,61,111,74,103,84,87,90,74,96,56,106,39,116,29,136,16,148,4,161,8,170,15,183,21,191,24,214,27,237,25,255,25,269,33,279,40,287,53,304,61,309,78,317,96,320,110,322,117,333,126,342,141,350,156,350,165,328,178,318,193,311,182,315,167,307,152,287,150,266,158,240,167,221,171,204,172,198,167,198,180,182,184,174,180,166,172,158,168,148,173,133,179,126,182,123,193,122,202,104,206,85,200,69,190,58,183,47,183,47,192,37,193,37,187,5,175" style="fill:black;stroke:#0080FF;stroke-width:3" />
        </svg>
        <div class="contain"></div>
