...
<head>
	...
	<script type="text/javascript" src="./public/assets/vendor/jquery/jquery-3.3.1.min.js"></script>
...
<body>
<div id="patrols">
    <div class="patrol">Alpha 1</div>
    <div class="patrol">Alpha 2</div>
    <div class="patrol">Alpha 3</div>
    <div class="patrol">Fox 1</div>
    <div class="patrol">Fox 2</div>
    <div class="patrol">Fox 3</div>
</div>
