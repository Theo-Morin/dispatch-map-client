...
<div class="container">
    ...
    <?php
        foreach($punaises as $punaise)
        {
            ...
            echo '<div onclick="delete_point(\'' . $punaise['punaid'] . '\')" class="punaise" id="' . $punaise['punaid'] . '" style="margin-top:' . $punaise['emplacementy'] . 'px;margin-left:' . $punaise['emplacementx'] . 'px;"></div>';
